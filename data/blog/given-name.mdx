...
The previous blog site of mine, [nir.moe](https://nir.moe), is named _Goddess Unknown_. The "Unknown" part, if I remember it right, comes from Player Unknown's Battlegrounds, a shooting game.
...
On second thought, I want to take a word from [_Misty E'ra_](https://youtu.be/QJlHmk1GLOA), a song in DJMAX Respect. It uses a conlang only appears in this song and a sequel, [_Misty E'ra "Mui"_](https://youtu.be/7gv3vx-E5bM). 'Misty' means flawless, pure. There is a word for 'voice', but I need to know which one it is.
...
From the first song, _Misty E'ra_:
